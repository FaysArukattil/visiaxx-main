...
class DistanceDetectionService {
  ...
  // Target distance for vision test (3 meters = 300 cm)
  static const double _targetDistanceCm = 300.0;
  static const double _toleranceCm = 20.0; // ±20cm tolerance
  ...
  static String getTargetDistanceMessage() {
    return 'Please maintain ${TestConstants.targetDistanceMeters}m (10 feet) distance';
  }
