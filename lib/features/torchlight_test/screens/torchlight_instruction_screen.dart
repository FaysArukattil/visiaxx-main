...
class TorchlightInstructionScreen extends StatefulWidget {
  const TorchlightInstructionScreen({super.key});

  @override
  State<TorchlightInstructionScreen> createState() =>
      _TorchlightInstructionScreenState();
}

class _TorchlightInstructionScreenState
    extends State<TorchlightInstructionScreen> {
  ...
  void _handleContinue() {
    _ttsService.stop();
    // Navigate to the first part of the examination: Pupillary Exam
    Navigator.pushReplacementNamed(context, '/pupillary-exam');
  }
                ...
                child: PageView(
                  ...
                  children: [
                    _buildStep(
                      ...
                      'Dim Environment',
                      'Find a dimly lit room and ensure your phone\'s flashlight is functional. Maintain ~40cm distance.',
                      context.warning,
                    ...
                    _buildStep(
                      ...
                      'Scanning Reflexes',
                      'The examiner will perform the swinging light test to observe pupil size and reactions.',
                      context.primary,
